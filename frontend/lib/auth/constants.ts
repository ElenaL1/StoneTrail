export const AUTH_MESSAGES = {
  ...
  yandexOauthFailed: "Не удалось войти через Яндекс. Попробуйте ещё раз.",
  yandexOauthCancelled: "Вход через Яндекс отменён.",
  yandexStateInvalid: "Сессия входа через Яндекс устарела. Начните ещё раз.",
  yandexAlreadyLinked: "Этот Яндекс ID уже привязан к другому аккаунту.",
  yandexNoEmail: "У аккаунта Яндекса нет email. Укажите почту в Яндексе и попробуйте снова.",
  yandexLinked: "Яндекс ID подключён.",
  yandexRateLimited: "Слишком много попыток. Подождите немного и попробуйте снова.",
